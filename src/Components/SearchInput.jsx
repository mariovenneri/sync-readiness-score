...
const SearchInput = ({ onTrackSelected }) => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-t from-black to-gray-950">
          ...
          <div className="bg-gray-950 rounded-3xl shadow-2xl p-8 border-gray-900 border">
            ...
            <div className="relative pb-10">
              ...
              {(loading || results.length > 0) && (
                <div className="absolute left-0 right-0 top-full mt-2 mb-8 bg-black/90 backdrop-blur-2xl rounded-2xl border border-blue-700/50 shadow-2xl overflow-hidden z-50">
                  {loading && (
