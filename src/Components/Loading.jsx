...
const Loading = ({ track, onComplete }) => {
  ...
  <div className="min-h-screen bg-white flex items-center justify-center px-4">
    <div className="w-full max-w-2xl">
      <div className="relative bg-gray-800 rounded-3xl shadow-2xl overflow-hidden p-12 text-center">
        {/* Bottom angled color layer */}
        <div 
          className="absolute inset-x-0 bottom-0 h-1/3 bg-blue-900/40"
          style={{ clipPath: "polygon(0 0%, 100% 0%, 100% 100%, 0% 100%)" }} // adjust % for tilt
        />
        ...
        <div className="relative z-10">
          ...
          <div className="mb-10">
            ...
            <div className="flex justify-center items-center flex-wrap gap-2">
              <p className="text-white text-2xl tracking-tight leading-tight font-bold">"{track.title}"</p>
              <span className="text-blue-400 text-2xl">by {track.artist}</span>
            </div>
          </div>
          ...
          {currentStep === steps.length - 1 && (
            <div className="mt-12 max-w-xl mx-auto animate-fadeIn font-[Poppins]">
              <div className="flex items-center justify-center gap-3 mb-2">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-yellow-500/20 text-yellow-400 hover:text-yellow-300 hover:bg-amber-600/40">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </span>
                <p className="text-blue-200 text-lg font-medium">Did you know?</p>
              </div>
